...
class TimeLineController {
  constructor(
    ...
    super($kWindow, $timeout, $scope, MatterService, $compile);
  }
}

let timelineApp = angular.module('timelineApp', []);
timelineApp.controller('timelineController', function($scope) {
  $scope.timeline = {
    ...
    meta: {
      keywords:
        '个人简历,前端,后端,Resume,Web,JavaScript,JS,JQuery,AngularJS,ReactJS,NodeJS,Asp.Net,C#,WebSerice',
    ...
    info: {
      ...
      introductions: [
        ...
        },
        {
          id: 7,
          description:
            'JS系列：JQuery，AngularJS1，React(学习中)，AngularJS2(学习中)'
        },
        {
          id: 8,
      ...
      keywords:
        'Web开发 AngularJS ASP.NET C# HTML CSS SQL Oracle 互联网 电子商务',
      location: '求职地点',
      industry:
        '计算机软件 | 互联网/电子商务 | 广告 | 影视/媒体/艺术/文化传播 |其它',
      job:
        '全栈工程师 | Web前端开发 | 互联网软件开发工程师 | 软件UI设计师/工程师 | 软件工程师',
      jobtype: '全职',
      price: '薪资范围',
      arrivaltime: '到岗时间',
      trainings: [
    ...
    opensource: [
      {
        ...
        description:
          '关于identicons,一种类似于Gravatar的小东西,可将本类库引用,随机生成,保存数组到数据库,调用时用类库解析即可',
        image: '',
